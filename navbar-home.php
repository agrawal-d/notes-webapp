  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <button class="btn btn-primary home-login-btn" type="submit"><span class="fa fa-key"></span>Login</button>
      ...
      <li class="nav-item show-modal" data-uri="about.html" data-title="About Notes v0.1">
        <a class="nav-link" href="#"> <span class="fa fa-info-circle"></span>&nbsp;About Notes</a>
      </li>
            <li class="nav-item show-modal" data-uri="app.html" data-title="Android Application">
        <a class="nav-link" href="#"> <span class="fab fa-android"></span>&nbsp;Get the App</a>
      </li>
